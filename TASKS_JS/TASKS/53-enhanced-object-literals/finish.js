...
Потому что это "замыкание". когда функция вернул объект который хранит в себе другие фнукции(то есть функция вернула функцию), то в результате
возвращенная функция замыкается внутри этой функции когда создавалась и имеет доступ к параметрам этой функции
*/
