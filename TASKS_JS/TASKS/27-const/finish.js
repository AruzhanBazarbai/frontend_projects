...
// 1.потому что в переменной arr хранится ссылка на массив а не сам массив
// 2.потому что мы пытаемся изменить значение переменной арр, то есть сохранить ссылку на другой массив