...
const meanScore=(...arguments)=>{
  if(arguments.some((el)=>typeof el!=='number')) return "Все аргументы в вызове функции должны быть числами!"
  return arguments.reduce((cnt,el)=>cnt+el/arguments.length,0).toFixed(2)
}
